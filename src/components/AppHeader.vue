...
<template lang="">
  ...
  <div
    class="offcanvas my_offcanvasfilters offcanvas-bottom rounded-top"
    tabindex="-1"
    id="offcanvasBottom"
  ...
  >
    ...
    <div class="offcanvas-body small px-3">
      ...
      <section>
        ...
        <div class="row align-items-center mb-3 fs-6">
          <div class="col-10">
            <label class="form-check-label" for="servizio3"
              >Posto macchina</label
            >
          </div>
          <div class="col-2">
            <input
        ...
        <div class="row align-items-center mb-3 fs-6">
          <div class="col-10">
            <label class="form-check-label" for="servizio8"
        ...
        <div class="row align-items-center mb-3 fs-6">
          <div class="col-10">
            <label class="form-check-label" for="servizio9"
              >Riscaldamento</label
            >
          </div>
          <div class="col-2">
  ...
  <header class="w-100 fixed-top bg-light shadow-sm my_headersm">
    ...
    >
      <div class="row align-items-center">
        ...
        <div class="col-8">
          <strong class="my_searchtitle">Ovunque</strong><br />
          <p class="mb-1">Qualunque settimana &#x2022; Aggiungi ospiti</p>
        </div>
        <div class="col-2">
          <button
            class="btn my_filterbutton"
            type="button"
            data-bs-toggle="offcanvas"
  ...
  <nav class="w-100 fixed-bottom bg-light border-top my_navsm">
    <div class="container w-100 my_mapbtn text-center">
      <a href="#">
        <button class="btn btn-dark rounded-pill my_mapsm">
          Mappa <fa :icon="['fas', 'map']" />
        </button>
      </a>
    </div>
