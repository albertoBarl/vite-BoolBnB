...
<template lang="">
    ...
    <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasFooter" aria-labelledby="offcanvasFooterLabel">
    ...
    <footer class="bg-light border-top pb-5 my_footersm">
